    ...
    return (
        <div className='pt-28 relative max-sm:pt-16'>
            <div className='max-w-[1312px] px-4 mx-auto'>
                ...
                {MY_TAB.map((obj, i) => (
                    <div key={i} className={` max-sm:pt-[23px] ${open === obj.domain ? "" : "hidden"}`} >
                        {i === 0 ?
            ...
            <img src={greenLineOne} alt="green-line-1" className='absolute bottom-0 -z-10 max-sm:-bottom-[34%] h-4 max-md:object-cover w-full' />
            <img src={greenLineTwo} alt="green-line-2" className='absolute -bottom-5 -z-10 max-sm:-bottom-[36%] h-4 max-md:object-cover w-full' />
        </div>
    )
}
